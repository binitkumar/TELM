...
class Batch < ActiveRecord::Base
  ...
  named_scope :active,{ :conditions => { :is_deleted => false, :is_active => true },:joins=>:course,:select=>"batches.*,courses.code||'-'||batches.name as course_full_name",:order=>"course_full_name"}
  named_scope :inactive,{ :conditions => { :is_deleted => false, :is_active => false },:joins=>:course,:select=>"batches.*,courses.code||'-'||batches.name) as course_full_name",:order=>"course_full_name"}
  named_scope :deleted,{:conditions => { :is_deleted => true },:joins=>:course,:select=>"batches.*,courses.code||'-'||batches.name as course_full_name",:order=>"course_full_name"}
